import DragDivider from "@/components/base/DragDivider"
...
import Schedule from '@/components/function/Canlendar'
...
const HomeContent = () => {
    ...
    return (
        <div className="w-full h-full rounded-xl border border-border-dark">
            <DragDivider
